...
namespace nlrender
{
  const char* triangle_geom = "#version 400\n"
  "layout( triangles ) in;\n"
  ...
  const char* triangle_tes = "#version 400\n"
  "layout(triangles) in;\n"
  "\n"
  "in vec3 tcCenter[];\n"
  "in vec3 tcNormal[];\n"
  ...
  const char* triangle_frag = "#version 400\n"
  "out vec4 oColor;\n"
  "\n"
  "in vec3 normal;\n"
  "in vec3 L;\n"
  ...
  const char* triangle_tcs = "#version 400\n"
  ...
  const char* quad_tes = "#version 400\n"
  "layout(quads) in;\n"
  "\n"
  "in vec3 tcCenter[];\n"
  "in float r[];\n"
  ...
  const char* triangle_vert = "#version 400\n"
  ...
  const char* quad_tcs = "#version 400\n"
  ...
  const char* quad_vert = "#version 400\n"
  "subroutine float levelDistType( vec3 position );\n"
  "subroutine uniform levelDistType levelDist;\n"
  "\n"
  "in vec3 inVertex;\n"
  ...
  const char* quad_geom = "#version 400\n"
  "layout( triangles ) in;\n"
  "layout( triangle_strip, max_vertices = 3 ) out;\n"
  "\n"
  "in vec3 position[3];\n"
  ...
  const char* quad_frag = "#version 400\n"
  "out vec4 oColor;\n"
  "\n"
  "in vec3 normal;\n"
  "in vec3 L;\n"
